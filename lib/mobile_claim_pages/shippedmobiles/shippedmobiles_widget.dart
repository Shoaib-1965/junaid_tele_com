...
import 'shippedmobiles_model.dart';
export 'shippedmobiles_model.dart';
...
class ShippedmobilesWidget extends StatefulWidget {
  const ShippedmobilesWidget({super.key});

  static String routeName = 'Shippedmobiles';
  static String routePath = '/shippedmobiles';

  @override
  State<ShippedmobilesWidget> createState() => _ShippedmobilesWidgetState();
}

class _ShippedmobilesWidgetState extends State<ShippedmobilesWidget> {
  late ShippedmobilesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShippedmobilesModel());
  }
    ...
    return StreamBuilder<List<MobileClaimRecordsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MobileClaimRecordsRecord>
            shippedmobilesMobileClaimRecordsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final shippedmobilesMobileClaimRecordsRecord =
            shippedmobilesMobileClaimRecordsRecordList.isNotEmpty
                ? shippedmobilesMobileClaimRecordsRecordList.first
                : null;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: PreferredSize(
              ...
              child: AppBar(
                backgroundColor: Color(0xFFE9417A),
                                              ...
                                              context.pushNamed(
                                                ...
                                                queryParameters: {
                                                  'pagedocRef': serializeParam(
                                                    shippedmobilesMobileClaimRecordsRecord
                                                        ?.mobileDocRef,
