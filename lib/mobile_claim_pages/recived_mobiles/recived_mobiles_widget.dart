...
import 'recived_mobiles_model.dart';
export 'recived_mobiles_model.dart';
...
class RecivedMobilesWidget extends StatefulWidget {
  const RecivedMobilesWidget({super.key});

  static String routeName = 'RecivedMobiles';
  static String routePath = '/recivedMobiles';

  @override
  State<RecivedMobilesWidget> createState() => _RecivedMobilesWidgetState();
}

class _RecivedMobilesWidgetState extends State<RecivedMobilesWidget> {
  late RecivedMobilesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecivedMobilesModel());
  }
    ...
    return StreamBuilder<List<MobileClaimRecordsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MobileClaimRecordsRecord>
            recivedMobilesMobileClaimRecordsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final recivedMobilesMobileClaimRecordsRecord =
            recivedMobilesMobileClaimRecordsRecordList.isNotEmpty
                ? recivedMobilesMobileClaimRecordsRecordList.first
                : null;
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: PreferredSize(
              ...
              child: AppBar(
                backgroundColor: Color(0xFF03A7BC),
                                              ...
                                              context.pushNamed(
                                                ...
                                                queryParameters: {
                                                  'pagedocRef': serializeParam(
                                                    recivedMobilesMobileClaimRecordsRecord
                                                        ?.mobileDocRef,
