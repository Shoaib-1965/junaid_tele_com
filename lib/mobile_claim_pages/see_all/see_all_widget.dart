...
class SeeAllWidget extends StatefulWidget {
  ...
  static String routePath = '/seeAll';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<MobileClaimRecordsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MobileClaimRecordsRecord> seeAllMobileClaimRecordsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final seeAllMobileClaimRecordsRecord =
            seeAllMobileClaimRecordsRecordList.isNotEmpty
                ? seeAllMobileClaimRecordsRecordList.first
                : null;
                ...
                child: Column(
                  ...
                  children: [
                                ...
                                children: [
                                  ...
                                  Text(
                                    valueOrDefault<String>(
                                      formatNumber(
                                        seeAllMobileClaimRecordsRecord
                                            ?.mobileDocRef?.length,
                    ...
                    Padding(
                      ...
                      child: Builder(
                        builder: (context) {
                          final listofData = seeAllMobileClaimRecordsRecord
                                  ?.mobileDocRef
                                  ?.toList() ??
                              [];
